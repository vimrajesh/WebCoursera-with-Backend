...
<div class="container mt-4 mb-5">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active w3-text-red" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                    type="button" role="tab" aria-controls="home" aria-selected="true">About
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link w3-text-red" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                    type="button" role="tab" aria-controls="profile" aria-selected="false">Course Recording
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link w3-text-red" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                    ...
                    <table class="table table-bordered table-striped mt-3">
                        ...
                        <tr>
                            ...
                            <td><a class="link-primary"
                                   href="https://www.youtube.com/watch?v=bWPMSSsVdPk">Link</a>
                            </td>
        ...
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <table class="table table-striped table-hover table-bordered mt-3">
                ...
                <tr>
                    ...
                    <td><a class="link-primary"
                           href="https://www.dcpehvpm.org/E-Content/BCA/BCA-II/Web%20Technology/the-complete-reference-html-css-fifth-edition.pdf">Link</a>
                    </td>

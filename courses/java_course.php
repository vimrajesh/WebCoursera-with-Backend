...
<div class="container mt-4 mb-5">
    <h1 class="display-4" style="font-weight: 500;">Java</h1>
    <hr/>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                    role="tab" aria-controls="home" aria-selected="true">About
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                    role="tab" aria-controls="profile" aria-selected="false">Course Recording
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button"
                    role="tab" aria-controls="contact" aria-selected="false">Course Material
            </button>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="card mb-3 mt-3" style="max-width: 840px;">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="/webcoursera/assets/images/JAVA.png" class="img-fluid rounded-start pt-3" alt="...">
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    Complete guide to learning how to program in Java.
                                </li>
                                <li class="list-group-item">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <table class="table table-bordered table-striped mt-3">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Java Crash Course 1</td>
                            <td><a class="link-primary"
                                   href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a>
                            </td>
                            <td>3 mins</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Java Crash Course 2</td>
                            <td><a class="link-primary" href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a></td>
                            <td>30 mins</td>
                            <td><input type="checkbox" name="myTextEditBox2"/></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Java Crash Course 3</td>
                            <td><a class="link-primary" href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a></td>
                            <td>30 mins</td>
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <table class="table table-bordered table-striped mt-3">
                        ...
                        <tr>
                            <td>1</td>
                            <td>Introduction to Java - With Hands on</td>
                            <td><a class="link-primary" href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a></td>
                            <td>4hr 30 mins</td>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Intermediate Java - With Hands on</td>
                            <td><a class="link-primary" href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a></td>
                            <td>3hr 30 mins</td>
                        ...
                        <tr>
                            <td>3</td>
                            <td>Advanced Java - With Hands on</td>
                            <td><a class="link-primary" href="https://www.youtube.com/watch?v=UmnCZ7-9yDY">Link</a></td>
                            <td>4hr</td>
        ...
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <table class="table table-striped table-hover table-bordered mt-3">
                ...
                <tr>
                    <td>1</td>
                    <td>Fundamentals of Java</td>
                    <td>Dr. P Arjun</td>
                    <td><a class="link-primary" href="https://www.oracle.com/java/technologies/javase-documentation.html">Link</a>
                    </td>
                    <td>
                ...
                <tr>
                    <td>2</td>
                    <td>Learning Java made easy</td>
                    <td>Thomas A. Powell</td>
                    <td><a class="link-primary"
                           href="https://www.oracle.com/java/technologies/javase-documentation.html">Link</a>
                    </td>

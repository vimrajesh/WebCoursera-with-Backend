...
<div class="container mt-4 mb-5">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active w3-text-yellow " id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                    type="button" role="tab" aria-controls="home" aria-selected="true">About
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link w3-text-yellow" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                    type="button" role="tab" aria-controls="profile" aria-selected="false">Course Recording
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link w3-text-yellow" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                    ...
                    <table class="table table-bordered table-striped mt-3">
                        ...
                        <tr>
                            ...
                            <td><a class="link-primary"
                                   href="https://www.youtube.com/watch?v=hKB-YGF14SY">Link</a>
                            </td>
                            <td>3 mins</td>
        ...
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <table class="table table-striped table-hover table-bordered mt-3">
                ...
                <tr>
                    ...
                    <td><a class="link-primary"
                           href="https://www.w3schools.com/js/">Link</a>
                    </td>
